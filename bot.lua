...
BASE = '/home/api/Api/'
----------------------------------------------------------------------------
realm_id = -1001446901020 --Realm ID
----------------------------------------------------------------------------
SUDO = 358165791 --Sudo ID
----------------------------------------------------------------------------
sudo_users = {358165791,166674282} --Sudo ID
----------------------------------------------------------------------------
BOTS = 1744591401 --Bot ID
----------------------------------------------------------------------------
bot_id = 1744591401 --Bot ID
----------------------------------------------------------------------------
...
----------------------------------------------------------------------------
function is_bot(msg)
if tonumber(BOTS) == 1744591401 then
return true
else
return false
end
...
local channel = 't.me/ICEPHP'
local url , res = https.request('https://api.telegram.org/bot1744591401:AAHZH8jaAtiWvknzoxRdPuiEvWTLpcLTNxw/getchatmember?chat_id='..channel..'&user_id='..msg.sender_user_id_)
